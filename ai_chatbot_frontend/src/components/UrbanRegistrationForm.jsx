...
const UrbanRegistrationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePassword(password)) {
      setErrorMsg('Password must be at least 5 characters long, contain at least one number and one symbol.');
      return;
    }
    ...
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        ...
        <form onSubmit={handleSubmit}>
          <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Name" style={styles.input} required />
          ...
          <input type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="Confirm Password" style={styles.input} required />
